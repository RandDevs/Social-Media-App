	...
	return (
		<>
			<div className="w-screen h-screen overflow-hidden flex items-center justify-center shadow-lg relative">
				<form className="flex flex-col lg:w-3/5 bg-d-primary rounded-lg overflow-hidden items-center justify-center w-4/5">
					<div className="w-full h-36 bg-d-text rounded-lg relative group md:h-40 md:rounded-xl">
					...
					<div className="flex flex-col lg:w-1/2 w-3/4 h-84 items-center justify-between lg:-mt-8 -mt-4 py-4 lg:py-2">
					...
					<div className="flex justify-between w-full my-2">
						<div className="group">
							...
							<Link to={"/"}>
								<button className="lg:w-24 w-20 h-full bg-red-700 p-2 lg:rounded-xl rounded-lg font-semibold text-d-text ml-2 lg:text-base text-sm opacity-80 transition-all duration-300 hover:opacity-100">
									Back
								</button>
							</Link>
						</div>
						<div className="group">
							...
							<p>
								<button className="lg:w-24 w-20 bg-d-accent/70 p-2 lg:rounded-xl rounded-lg font-semibold text-d-text mr-2 opacity-80 text-sm h-full transition-all duration-300 hover:opacity-100">
									Next
								</button>
							</p>
						</div>
